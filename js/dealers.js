/* Triple R Trailers dealer locations.
   Locations researched from public listings, July 2026. Coordinates are
   city-level, close enough to route a buyer to the right town.
   To pin a dealer, fill in city, state, phone, lat, lng.
   Dealers without lat/lng stay in the site directory but are not pinned.
   Have the office confirm or correct any entry before print use. */
window.TRIPLE_R_DEALERS = [
  ...
  /* Mississippi */
  { name: "Murphy Bros", city: "Booneville", state: "MS", phone: "(662) 720-0022", lat: 34.672, lng: -88.552 },
  { name: "CDF Customs LLC", city: "Booneville", state: "MS", phone: "", lat: 34.645, lng: -88.585 },
  ...
  { name: "David's Used Cars", city: "New Houlka", state: "MS", phone: "(662) 568-2553", lat: 34.03, lng: -89.02 },
  ...
  { name: "Smith's Enterprises", city: "Brookhaven", state: "MS", phone: "(601) 757-7711", lat: 31.58, lng: -90.44 },
  { name: "TBJ Trailers & Portable Bldgs LLC", city: "Tylertown", state: "MS", phone: "(601) 730-4082", lat: 31.12, lng: -90.14 },
  { name: "One Stop Trailer Shop LLC", city: "Picayune", state: "MS", phone: "(504) 258-4759", lat: 30.53, lng: -89.68 },
  ...
  { name: "Rival Feed & Seed LLC", city: "Muscle Shoals", state: "AL", phone: "(256) 814-1913", lat: 34.745, lng: -87.655 },
  { name: "Johnny's 4 Wheelers", city: "Red Bay", state: "AL", phone: "(256) 919-1804", lat: 34.44, lng: -88.14 },
  ...
  /* Arkansas */
  { name: "Grady's", city: "Ward", state: "AR", phone: "", lat: 35.03, lng: -91.95 },
